    ...
    <section className="w-screen h-[100vh] lightBg relative">
      ...
      <div className="h-[100vh] w-[100vw] z-[-2]">
        <section className="w-screen h-screen flex flex-col items-center justify-center p-2 lg:p-6 relative">
          ...
          <div className="absolute bottom-10 left-5 md:left-8 lg:left-10 cursor-pointer z-[6] roboticFont">
            <div
          ...
          <div className="absolute bottom-10 right-5 md:right-8 lg:right-10 cursor-pointer z-[6] roboticFont">
