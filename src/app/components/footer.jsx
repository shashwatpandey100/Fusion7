        ...
        <section className='w-screen h-[600px] pt-[6vw] pb-[4vw] px-10'>
            <div className='h-full w-full flex'>
                ...
                <div className='h-full w-[65%] flex justify-between items-center'>
                    ...
                    <div className='w-[50%] flex justify-between text-[0.95vw] font-[500]'>
                        <div className='w-[150px] h-[200px]'>
                            <span className='flex mb-2'>Follow us</span>
                            <ul>
                                <li className='flex cursor-pointer mb-2 group'>Instagram<span className='pt-1 pl-2 group-hover:animate-slant'><BsArrowUpRight className='group-hover:rotate-45 duration-300' /></span></li>
                                <li className='flex cursor-pointer mb-2 group'>Linkedin<span className='pt-1 pl-2 group-hover:animate-slant'><BsArrowUpRight className='group-hover:rotate-45 duration-300' /></span></li>
                                <li className='flex cursor-pointer mb-2 group'>Twitter<span className='pt-1 pl-2 group-hover:animate-slant'><BsArrowUpRight className='group-hover:rotate-45 duration-300' /></span></li>
                                <li className='flex cursor-pointer mb-2 group'>Facebook<span className='pt-1 pl-2 group-hover:animate-slant'><BsArrowUpRight className='group-hover:rotate-45 duration-300' /></span></li>
                            </ul>
                        </div>
                        ...
                        <div className='w-[150px] h-[200px]'>
                            <ul>
                                ...
                                <li className='cursor-pointer mb-2'>Our Work</li>
                                <li className='cursor-pointer mb-2'>Contact Us</li>
                            </ul>
                        </div>
                    </div>
                </div>
